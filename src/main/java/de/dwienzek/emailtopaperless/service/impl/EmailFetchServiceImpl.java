...
public class EmailFetchServiceImpl implements EmailFetchService {
    ...
    private static final Logger LOGGER = LogManager.getLogger(EmailFetchServiceImpl.class);
    private static final String PROTOCOL = "imap";

    private final ImapConfiguration configuration;

    @Override
    public void fetchEmails(Consumer<MimeMessage> function) throws EmailFetchException {
        try {
            ...
            throw new EmailFetchException(exception);
        }
    }
